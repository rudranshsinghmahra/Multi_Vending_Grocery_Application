...
class _TopPickedStoreState extends State<TopPickedStore> {
  ...
  Widget build(BuildContext context) {
    ...
    actualShopDistance.sort(); // this will sort with nearest distance. If nearest distance
    if(actualShopDistance[0]>10){
      return Column(
        children: const [
          Padding(
            padding: EdgeInsets.only(left: 20,top: 20),
            child: Text("No Store Within 10km",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
          )
        ],
      );
    }
